/*
  # Add Audit Monitoring Function
  
  ## Purpose
  Provides a dashboard view of all audits with health status
  
  ## Features
  - Shows audit status and completion metrics
  - Identifies stuck audits
  - Shows fallback usage from logs
  - Useful for monitoring and debugging
*/

-- Function to monitor audit health
