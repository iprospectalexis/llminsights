/*
  # Fix Scheduled Audits URL Resolution

  1. Changes
    - Update process_scheduled_audits_direct() to use public Supabase URL
    - Fix "Couldn't resolve host name" error in pg_net
  
  2. Notes
    - The internal 'http://kong:8000' URL doesn't resolve from pg_net
    - Using the public SUPABASE_URL instead
*/

-- Update the process_scheduled_audits_direct function to use public URL
