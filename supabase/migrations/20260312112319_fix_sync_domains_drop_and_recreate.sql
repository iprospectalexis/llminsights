/*
  # Fix sync_domains Function - Drop and Recreate
...
DROP FUNCTION IF EXISTS sync_domains_from_citations(uuid);

-- Recreate with fixed column names
CREATE OR REPLACE FUNCTION sync_domains_from_citations(p_project_id uuid DEFAULT NULL)
RETURNS TABLE(
  synced_project_id uuid,
  domains_inserted bigint,
